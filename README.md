...
It uses the [adamite](https://github.com/juumixx/adamite) library to control Philips Hue lights from the browser.
...
1. Fork it ( https://github.com/your-github-user/home/fork )
