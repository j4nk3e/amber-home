...
Amber::Server.configure do |settings|
  ...
  #
  # settings.name = "Home web application."
  #
  #
  ...
  #
  # settings.secret_key_base= qt6OaUrZTkelkaMKhEwKTkqtj-iujT0bh1_SPtKKxcs
  #
  #
  ...
  #
  # settings.logger = Amber::Environment::Logger.new(File.open("home.log", "w"))
  #
  #
end
